...
class AddUpdateName extends StatefulWidget {
  static const routeName = '/addUpdateName';

  @override
  _AddUpdateNameState createState() => _AddUpdateNameState();
}

class _AddUpdateNameState extends State<AddUpdateName> {
  ...
  Widget buildFirstNameInput(previousFirstName) {
    return Padding(
      ...
      child: TextFormField(
        ...
        validator: (value) =>
            value.isEmpty ? getTranslate(context, 'FILL_IN_FIELD') : null,
        onSaved: (value) => _firstName = capitalizeString(value.trim()),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(getTranslate(context, "FIRST_AND_LAST_NAME")),
      ),
      body: Form(
        key: _formKey,
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                getTranslate(context, "FIRST_AND_LAST_NAME_NOTICE"),
