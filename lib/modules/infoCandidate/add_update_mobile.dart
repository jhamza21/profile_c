...
class AddUpdateMobile extends StatefulWidget {
  static const routeName = '/addUpdateMobile';

  @override
  _AddUpdateMobileState createState() => _AddUpdateMobileState();
}

class _AddUpdateMobileState extends State<AddUpdateMobile> {
          ...
          : () async {
              if (validateAndSave()) {
                try {
                  ...
                  userProvider.setMobile(_mobile);
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                getTranslate(context, "MOBILE_NUMBER_NOTICE"),
                style: TextStyle(color: GREY_LIGHt),
              ),
              SizedBox(height: 20.0),
              buildMobileInput(userProvider.user.mobile),
