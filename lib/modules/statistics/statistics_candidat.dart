...
class StatisticsCandidat extends StatefulWidget {
  static const routeName = '/statisticsCandidat';

  @override
  _StatisticsCandidatState createState() => _StatisticsCandidatState();
}

class _StatisticsCandidatState extends State<StatisticsCandidat> {
  bool _isWeek = true;
  ...
  Widget build(BuildContext context) {
    ...
    int _nbCompare = _isWeek
        ? statisticProvider.nbComparisionW
        : statisticProvider.nbComparisionM;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10),
                        StatisticItem(
                            Image.asset(COMPARISION_ICON),
                            "$_nbCompare ${getTranslate(context, "COMPARISONS")}",
                            getTranslate(context, "YOUR_PROFILE")),
                        SizedBox(height: 10),
                        StatisticItem(
